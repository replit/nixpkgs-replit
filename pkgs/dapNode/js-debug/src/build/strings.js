...
const strings = {
    ...
    'extensionHost.launch.debugWebviews': 'Configures whether we should try to attach to webviews in the launched VS Code instance. **Note:** at the moment this requires the setting `"webview.experimental.useIframes": true` to work properly, and will only work in desktop VS Code.',
    ...
    'debug.terminal.welcome': `[JavaScript Debug Terminal](command:${"extension.js-debug.createDebuggerTerminal" /* CreateDebuggerTerminal */})\n\nYou can use the JavaScript Debug Terminal to debug Node.js processes run on the command line.`,
    'debug.terminal.welcomeWithLink': `[JavaScript Debug Terminal](command:${"extension.js-debug.createDebuggerTerminal" /* CreateDebuggerTerminal */})\n\nYou can use the JavaScript Debug Terminal to debug Node.js processes run on the command line.\n\n[Debug URL](command:${"extension.js-debug.debugLink" /* DebugLink */})`,
...
if (require.main === module) {
    process.stdout.write(JSON.stringify(objUtils_1.sortKeys(strings)));
}
