...
stdenv.mkDerivation {
  ...
  patchPhase = ''
    ...
    patch -p1 -d llvm-project/compiler-rt -i ${./patches/libsanitizer-no-cyclades-11.patch}
  ...
  checkPhase = ''
    ...
    export LIBRARY_PATH=${lib.makeLibraryPath [icu libgcc libuuid.lib]}:$l
  ...
  installPhase = ''
    ...
    wrapProgram $out/bin/swift \
      ...
      --suffix LIBRARY_PATH : ${lib.makeLibraryPath [icu libgcc libuuid]}/lib
